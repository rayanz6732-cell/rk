...
export default function RKSidebar({ user }) {
  ...
  const accent  = THEME_ACCENTS[user?.theme] || '#f472b6';
  ...
  return (
    <>
      <style>{`
        ...
        /* Hide on mobile — BottomTabBar + Navbar handle it */
        ...
        .rksb-item.active { background: ${accent}18; }
        ...
        .rksb-label { font-size: 13px; font-weight: 700; color: #94a3b8; }
              ...
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge && (
                      <span className="rksb-badge" style={BADGE_STYLES[item.badgeType] || BADGE_STYLES.num}>
                        {item.badge}
                      </span>
                    )}
                  </Link>
